      ...
      if (rt.href) {
        ...
        if (resolved.keep) {
          ...
          if (!isInternal && isSponsoredLink(resolved.href)) {
            // Sponsored/affiliate links render as buttons wherever they
            // appear (no special block wrapper needed) — first sponsored
            // link in a given rich-text run is the primary (solid) button,
            // any additional one is the secondary (text-link) style.
