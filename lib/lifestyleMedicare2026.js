...
export const MEDICARE_2026 = {
  ...
  // filer, based on 2024 MAGI (Medicare's official 2-year lookback). Source:
  ...
  // Married-filing-jointly brackets. NOT simply 2x the individual brackets
  // throughout — the first four tiers are exactly double, but the top
  // threshold is a documented exception (a 2017 anti-avoidance provision
  // fixed it at $750,000 instead of the "expected" $1,000,000). Getting
  // this wrong by assuming a flat 2x multiplier would misclassify any
  // household between $500,000 and $750,000 MAGI into the wrong bracket.
  irmaaBrackets2026MarriedJoint: [
    { magiUpTo: 218000, partBMonthly: 202.90, partDAdjustment: 0 },
    { magiUpTo: 274000, partBMonthly: 284.10, partDAdjustment: 14.50 },
    { magiUpTo: 342000, partBMonthly: 405.80, partDAdjustment: 37.50 },
    { magiUpTo: 410000, partBMonthly: 527.50, partDAdjustment: 60.60 },
    { magiUpTo: 750000, partBMonthly: 649.20, partDAdjustment: 83.60 },
    { magiUpTo: Infinity, partBMonthly: 689.90, partDAdjustment: 91.00 },
  ],
